...
(ID_RESIDENCIA, NUMERO_DA_CASA, DESCRICAO, RUA, BAIRRO, CIDADE, ESTADO_SIGLA, ESTADO_NOME)
AS
SELECT RD.ID_RESIDENCIA, RD.NUMERO AS RESIDENCIA_NUMERO, RD.DESCRICAO AS RESIDENCIA_DESCRICAO, RUA.NOME AS RUA, BRR.NOME AS BAIRRO, CD.NOME AS CIDADE, ES.SIGLA, ES.NOME AS NOME_ESTADO FROM RESIDENCIA AS RD INNER JOIN RUA ON RUA.ID_RUA = RD.IDFK_RUA INNER JOIN BAIRRO AS  BRR ON RUA.IDFK_BAIRRO = BRR.ID_BAIRRO INNER JOIN CIDADE AS CD ON CD.ID_CIDADE = BRR.IDFK_CIDADE INNER JOIN ESTADO AS ES ON ES.ID_ESTADO = CD.IDFK_ESTADO 
