...
public class TelaDeOpcoesDeAtualizacao extends javax.swing.JFrame {
     ...
     */
    public TelaDeOpcoesDeAtualizacao() {
        initComponents();
    ...
    private void initComponents() {
        ...
        scrollPaneDistribuidor = new javax.swing.JScrollPane();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jTabbedPane1.addTab("Cliente", scrollPaneCliente);
        jTabbedPane1.addTab("Produto", scrollPaneProduto);
        jTabbedPane1.addTab("Distribuidor", scrollPaneDistribuidor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeOpcoesDeAtualizacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeOpcoesDeAtualizacao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JScrollPane scrollPaneDistribuidor;
