 ...
 * @author pedroh
 */
public class CardClienteSemEmail extends javax.swing.JPanel {
    ...
    public CardClienteSemEmail(Cliente clienteDoContainer) {
        initComponents();
    ...
    public void conectarLabelsComCliente() {
        ...
        lbEmail.setText("Não possui");
        lbCodigo.setText(String.valueOf(getClienteDoContainer().getIdCliente()));
//        lbTelefone.setText(getClienteDoContainer().);
        lbNumero.setText(String.valueOf(getClienteDoContainer().getEndereco().getResidencia().getNumero()));
        lbDescricao.setText(getClienteDoContainer().getEndereco().getResidencia().getDescricao());
        lbRua.setText(getClienteDoContainer().getEndereco().getRua().getNome());
        lbBairro.setText(getClienteDoContainer().getEndereco().getBairro().getNome());
        lbCidade.setText(getClienteDoContainer().getEndereco().getCidade().getNome());
        lbEstado.setText(getClienteDoContainer().getEndereco().getEstado().getSigla());
    ...
    private void initComponents() {
        ...
        lnNumeroText = new javax.swing.JLabel();
    ...
    private javax.swing.JLabel lnNumeroText;
