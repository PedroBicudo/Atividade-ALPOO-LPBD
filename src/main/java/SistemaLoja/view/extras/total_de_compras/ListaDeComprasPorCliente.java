 ...
 * @author pedroh
 */
public class ListaDeComprasPorCliente extends javax.swing.JFrame {
     ...
     */
    public ListaDeComprasPorCliente() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaDeComprasPorCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaDeComprasPorCliente().setVisible(true);
            }
        });
    }
